...
const RestaurantDisplay = () => {
    const { restaurant, images, restaurants, setTheRestaurant, progress,displayAlert } = useContext(RestaurantContext);//extract the restaurant from the context; Now there is access to all the details of the restaurant
    ...
    return (
        <>
            ...
            <div className='container col-xxl-8 px-4 my-md-3 py-lg-3'>
                ...
                {disabled && <div style={{ minHeight: "20px" }}>
                    <Spinner />
                </div>}
