...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        "handler": async function (response) { //this function runs on successful verification
          ...
          try {
            ...
            if (verificationResponse.data.success) {//if payment is successful
              ...
              displayAlert('Successfully Registered to Huduki!', 'success',2000);

              await fetchRestaurants();
              navigate("/login");

            } else {//if payment is unsuccessful
              displayAlert('Payment verification failed! Try again.', 'danger',2000);
            }
      ...
      displayAlert('Form submission failed! Try again.', 'danger',2000);
